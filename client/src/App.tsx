                                ...
                                <>
                                    ...
                                    {loading ? (
                                        ...
                                        <div className="text-center py-12">
                                            <p className="text-gray-500">No scripts found. Upload one to get started!</p>
                                        </div>
                                    )}
                                </>
                            }
                        />
                        <Route path="/upload" element={<UploadForm onUploadSuccess={handleUploadSuccess} />} /> {/* Pass handleUploadSuccess */}
                    </Routes>
                </main>
