            ...
            <div className="min-h-screen bg-gray-100">
                <Helmet>
                    ...
                    <meta name="description"
                          content="Discover and share your scripts with the developer community. Find the perfect script for your project from our vast collection of user-submitted code snippets."/>
                    <meta name="keywords"
                          content="scripts, code sharing, developer community, programming, code snippets"/>
                                ...
                                <>
                                    ...
                                    {loading ? (
                                        ...
                                        <div
                                            ...
                                            {scripts.map(script => (
                                                <ScriptCard key={script.id} script={script} loading={false}/>
                                            ))}
                                        </div>
                                    ) : (
